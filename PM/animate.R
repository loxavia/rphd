...
patients
patients2 <- patients %>% dplyr::sample_n(20)
...
#Tokens to images-----
animate_process(patients2, mapping=token_aes(shape='image', size=token_scale(10), image= token_scale('https://upload.wikimedia.org/wikipedia/en/5/5f/Pacman.gif')))
